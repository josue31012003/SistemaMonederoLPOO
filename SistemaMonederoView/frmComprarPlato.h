...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox2->Size = System::Drawing::Size(445, 245);
			...
			this->textBox1->Location = System::Drawing::Point(213, 192);
			...
			this->label3->Location = System::Drawing::Point(66, 198);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(141, 16);
			this->label3->TabIndex = 8;
			this->label3->Text = L"Saldo Disponible (S/.) ";
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(439, 646);
			...
			this->label2->Location = System::Drawing::Point(67, 672);
			...
			this->dateTimePicker1->Location = System::Drawing::Point(128, 673);
			this->dateTimePicker1->Name = L"dateTimePicker1";
			this->dateTimePicker1->Size = System::Drawing::Size(94, 22);
			...
			this->ClientSize = System::Drawing::Size(984, 726);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (dataGridView2->Rows[0] != nullptr && this->dataGridView2->Rows[0]->Cells[0] != nullptr && dataGridView2->Rows[0]->Cells[0]->Value != nullptr && textBox6->Text != nullptr) {
		...
		double saldoActual = objTarjetaController->obtenerSaldoxRFID(codigoRFID);
		...
		if (monto> saldoActual) {
			...
			for each (DataGridViewRow ^ row in dataGridView2->Rows) {
				...
				try {
					if (row->Cells[0]->Value != nullptr && row->Cells[2]->Value != nullptr) {
						...
						listaPlatosVendidos->Add(objPlatoVendido);
						cantidadInicial += cantidadSeleccionada;
					}
				}
				catch (System::FormatException^ ex) {
			...
			saldoFinal = saldoActual - monto;   //Este es el saldo al finalizar la recarga 
