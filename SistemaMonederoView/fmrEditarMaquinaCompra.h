...
namespace SistemaMonederoView {
	...
	/// <summary>
	/// Resumen de fmrEditarMaquinaCompra
	/// </summary>
	public ref class fmrEditarMaquinaCompra : public System::Windows::Forms::Form
	{
	public:
		fmrEditarMaquinaCompra(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(280, 257);
			...
			this->groupBox1->Location = System::Drawing::Point(32, 60);
			...
			this->ClientSize = System::Drawing::Size(505, 349);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"fmrEditarMaquinaCompra";
			this->Text = L"fmrEditarMaquinaCompra";
